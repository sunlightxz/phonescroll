...
const App = () => {
  ...
  return (
    <div className="overflow-hidden">
      ...
      <div
        ref={heroImageRef}
        className="justify-center items-center md:p-3 p-2 bg-[#D2C6DC]  top-[20%] xl:w-[330px] md:w-[280px] w-[240px]  absolute md:right-[10%] right-[5%] border-white border rounded-3xl hidden sm:flex"
      >
